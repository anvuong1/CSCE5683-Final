...
parser.add_argument('--pth_path', type=str, default='/home/tanb/camouflaged/BGNet/checkpoints/BGNet/BGNet-24.pth')

for _data_name in ['CAMO','CHAMELEON','COD10K','NC4K']:
    data_path = '/home/tanb/camouflaged/TestDataset/{}/'.format(_data_name)
    save_path = './results/Retrain_HE_test/{}/'.format(_data_name)
